	...
	<body>
		...
		<div id="show-task" class="content scaffold-show" role="main">
			...
			<ol class="property-list task">
				...
				<li class="fieldcontain">
					<span id="projectName-label" class="property-label"><g:message code="task.projectName.label" default="Project Name" /></span>
					
						<span class="property-value" aria-labelledby="projectName-label"><g:link controller="project" action="show" id="${taskInstance?.projectName?.id}">${taskInstance?.projectName?.encodeAsHTML()}</g:link></span>
