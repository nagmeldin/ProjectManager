	...
	<body>
		...
		<div id="show-endUser" class="content scaffold-show" role="main">
			...
			<ol class="property-list endUser">
				...
				<g:if test="${endUserInstance?.firstName}">
				<li class="fieldcontain">
					<span id="firstName-label" class="property-label"><g:message code="endUser.firstName.label" default="First Name" /></span>
					
						<span class="property-value" aria-labelledby="firstName-label"><g:fieldValue bean="${endUserInstance}" field="firstName"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${endUserInstance?.lastName}">
				<li class="fieldcontain">
					<span id="lastName-label" class="property-label"><g:message code="endUser.lastName.label" default="Last Name" /></span>
					
						<span class="property-value" aria-labelledby="lastName-label"><g:fieldValue bean="${endUserInstance}" field="lastName"/></span>
