		...
		<div id="list-endUser" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="firstName" title="${message(code: 'endUser.firstName.label', default: 'First Name')}" />
					
						<g:sortableColumn property="lastName" title="${message(code: 'endUser.lastName.label', default: 'Last Name')}" />
				...
				<g:each in="${endUserInstanceList}" status="i" var="endUserInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: endUserInstance, field: "lastName")}</td>
			...
			<div class="pagination">
				<g:paginate total="${endUserInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
