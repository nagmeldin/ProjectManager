	...
	<body>
		...
		<div id="show-project" class="content scaffold-show" role="main">
			...
			<ol class="property-list project">
				...
				<g:if test="${projectInstance?.billType}">
				<li class="fieldcontain">
					<span id="billType-label" class="property-label"><g:message code="project.billType.label" default="Bill Type" /></span>
					
						<span class="property-value" aria-labelledby="billType-label"><g:fieldValue bean="${projectInstance}" field="billType"/></span>
