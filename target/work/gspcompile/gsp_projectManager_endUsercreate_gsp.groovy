...
class gsp_projectManager_endUsercreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/endUser/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',35,['url':([resource:endUserInstance, action:'save'])],2)
printHtmlPart(22)
})
