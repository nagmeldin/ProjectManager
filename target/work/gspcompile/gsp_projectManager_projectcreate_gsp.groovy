...
class gsp_projectManager_projectcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(projectInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(projectInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:projectInstance, action:'save'])],2)
printHtmlPart(22)
})
